<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alogin.aspx.cs" Inherits="BankingApplication.Alogin" %>
...
<body>
    ...
    <div class="fixed-header" style="text-align: center; left: -3px; height: 19px;">
            <asp:Button ID="LogoutBtn" runat="server" OnClick="Button5_Click" style="position: absolute; right: 83px; top: 4px; height: 25px; width: 60px; left: 1158px;" Text="Home" />
        Admin Login</div>
    <div class="logincontent">
       ...
       <asp:TextBox ID="UserText" runat="server" ></asp:TextBox>
        ...
        <div class="loginremember">
            <br />
            <asp:Button ID="btnSubmit" runat="server" Text="login" Height="35px" OnClick="btnSubmit_Click" Width="73px" style="margin-left: 0px; margin-top: 0px;" />
        </div>
    </div>
    </form>
